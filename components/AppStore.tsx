...
export const AppStore: React.FC<AppStoreProps> = ({ onClose, onInstall }) => {
    ...
    return (
        <motion.div
            ...
            className="w-[800px] h-[700px] bg-black/20 backdrop-blur-3xl rounded-[48px] shadow-2xl overflow-hidden flex flex-col border border-white/10"
        >
            {/* Header */}
            <div className="pt-10 px-12 pb-6 flex items-center justify-between">
                <h1 className="text-2xl font-medium text-white/90">App Store</h1>
                ...
                >
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="white/60" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
